      ...
      <AppLayout>
        ...
        <div className="px-4 pt-2 pb-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[34px] font-extrabold text-black tracking-tight">Pharmacy & Beauty</h1>
          </div>
        ...
        <div className="px-4 mb-6">
          <div className="relative">
            ...
            <input 
              type="text" 
              placeholder="Search in Pharmacy & Beauty" 
        ...
        {/* Categories */}
        <Categories category="pharmacy" />

        {/* Filters */}
        <FilterChips category="pharmacy" />

        {/* Promo Banner */}
        <PromoBanner />

        {/* Restaurants List */}
        <RestaurantCard category="pharmacy" />
